...
def score():
    global count_player_one, count_player_two, player_one_is_last_winner, player_two_is_last_winner, count_second, player_one, player_two
...
def rule():
    ask_rule=input('Do you want read the rules? write yes or no ')
    if ask_rule=="yes":
        print('The goal of the tic tac toe is doing row,column or diagonal with the same symbole. The first player play the x symbol and the second play o the first game. The looser always play first and take x symbol. For set up the position of your symbol you must write x,y x for the column you choose and y for the row you choose')

def main():
    global count, win, winner, player_one_is_last_winner, player_two_is_last_winner, player_one, player_two
